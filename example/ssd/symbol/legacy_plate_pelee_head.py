...
#######################################################
	...
	# sizes = [[0.1, 0.15, 0.20], [0.25, 0.30, 0.35], [0.40, 0.45, 0.5]]
	# ratios = [[0.5, 1.5, 2.5],[0.5, 1.5, 2.5, 3.5], [0.5, 1.5, 2.5]] 
	sizes = [[0.9, 0.12, 0.15], [0.18, 0.21, 0.24], [0.27, 0.3, 0.33]]
	ratios = [[1.5, 2, 3],[1.5, 2, 2.6, 3.2], [1.5, 2, 2.6, 3.2]]   
