...
from common_test import multibox_layer
...
#######################################################
	...
	tmp = mx.symbol.contrib.MultiBoxTarget(
		*[anchor_boxes, label, cls_preds], overlap_threshold=.5, \
		ignore_label=-1, negative_mining_ratio=0, minimum_negative_samples=0, \
	...
	cls_prob = mx.sym.Custom(op_type='FocalLoss', name = 'cls_prob', data=cls_preds, num_classes = num_classes,\
		labels=cls_target,alpha =0.25, gamma= 2,use_ignore=True,ignore_label=-1) 
