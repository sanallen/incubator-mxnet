...
def parse_args():
    # dic = {network:'legacy_pelee_SSD_v4_reduce_3x3_3_ron'}
    network = 'legacy_pelee_SSD_v3xs'
    data_shape = '320'
    epoh = 249
    # network = 'legacy_pelee_SSD_v4_reduce_3x3_3_ron'
    ...
    parser.add_argument('--epoch', dest='epoch', help='epoch of trained model',
                        default=epoh, type=int)
    parser.add_argument('--prefix', dest='prefix', help='trained model prefix',
                        # default=os.path.join(os.getcwd(), 'model', network,'ssd_320_'),
                        default='/opt/incubator-mxnet/example/ssd/model/ssd_legacy_pelee_SSD_v1_320',
                        type=str)
    parser.add_argument('--cpu', dest='cpu', help='(override GPU) use CPU to detect',
                        action='store_true', default=False)
    parser.add_argument('--gpu', dest='gpu_id', type=int, default=0,
                        help='GPU device id to detect with')
    parser.add_argument('--data-shape', dest='data_shape', type=str, default=data_shape,
                        help='set image shape')
    parser.add_argument('--mean-r', dest='mean_r', type=float, default=123,
                        help='red mean value')#123,117,104
    ...
    parser.add_argument('--no-force', dest='force_nms', action='store_true',
    ...
    parser.add_argument('--deploy', dest='deploy_net', action='store_true', default=True,
...
if __name__ == '__main__':
    ...
    image_list = [y for x in os.walk('/mnt/ExtraSSD/data/VOC-LPR/VOC2007/JPEGImages') for y in glob.glob(os.path.join(x[0], '*.jpg'))]
    # image_list = [y for x in os.walk('/mnt/ExtraSSD/data/车头错检/错检原图') for y in glob.glob(os.path.join(x[0], '*.jpg'))]
    ...
    detector.detect_and_visualize(image_list, args.dir, args.extension,
    							  class_names, args.thresh, args.show_timer, '/mnt/ExtraSSD/data/VOC-LPR/VOC2007/detect_wxw')
    # detector.detect_and_visualize(image_list, args.dir, args.extension,
                                #   class_names, args.thresh, args.show_timer, '/mnt/ExtraSSD/data/车头错检/detect_wxw')
