...
def get_symbol(num_classes = 78, loss = 'ctc', seq_len = 24, dtype = 'float32', **kwargs):
    ...
    s3_conv1 = mx.sym.Convolution(data = s3_pool1, num_filter = cout[2], kernel = (5, 1), stride = (1, 1), 
    ...
    s3_conv2 = mx.sym.Convolution(data = s3_act1, num_filter = num_classes + 1, kernel = (1, 13), 
...
if __name__ == '__main__':
    ...
    mx.viz.plot_network(net, shape={"data" : (1, 3, 94, 24)}, node_attrs={"shape":'rect',"fixedsize":'false'}).view('lprnet_concat_deploy')